    ...
    async def __call__(self, request: Request):
        ...
        if credentials:
            ...
            if not verification_status['payload']:
                raise HTTPException(status_code=status.HTTP_422_UNPROCESSABLE_ENTITY, detail='JWT Payload could not be extracted.')
